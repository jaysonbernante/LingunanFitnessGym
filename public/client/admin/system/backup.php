...
<style>
    ...
    @media (max-width: 900px) { .bk-wrap { padding: 18px 16px; } }
    ...
    @media (max-width: 600px) {
        .btn-export, .btn-select-all, .btn-import { font-size: 14px; padding: 10px; }
    }
    ...
    /* ── History table ───────────────────────────────────────────── */
    .bk-hist-table { width: 100%; border-collapse: collapse; font-size: 13px; min-width: 700px; }
    ...
    @media (max-width: 600px) {
        .bk-hist-table { min-width: 0; }
        .bk-hist-table thead { display: none; }
        .bk-hist-table tbody tr { display: block; margin-bottom: 12px; border: 1px solid rgba(255,255,255,0.03); border-radius: 8px; padding: 8px; background: #1b1b1b; font-size: small; }
        .bk-hist-table tbody td { display: flex; justify-content: space-between; align-items: center; padding: 8px 10px; border-bottom: none; white-space: normal; }
        .bk-hist-table tbody td::before { content: attr(data-label); color: #1976d2; font-weight: 700; margin-right: 8px; width: 100px; flex: 0 0 100px; }
    }
    .bk-hist-table-wrap { width: 100%; overflow-x: auto; -webkit-overflow-scrolling: touch; }
        ...
        <div id="historyWrap">
            ...
            <table class="bk-hist-table">
                ...
                <tr data-file="<?php echo htmlspecialchars($bk['name']); ?>">
                    <td data-label="Filename" style="font-family:monospace; color:#90caf9;"><?php echo htmlspecialchars($bk['name']); ?></td>
                    <td data-label="Size"><?php echo $bk['size']; ?> KB</td>
                    <td data-label="Created"><?php echo $bk['time']; ?></td>
